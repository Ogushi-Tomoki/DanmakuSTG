...
//check_time.cpp
	GLOBAL void enter_func_tm(const char st[], int flag = 0);
...
//setting.cpp
	GLOBAL void set_config(int *SettingNum);

//save_and_load.cpp
	GLOBAL void DataSave(save_data_t* save_data);
	GLOBAL void DataLoad(save_data_t* save_data);

//termination.cpp
	GLOBAL void termination();
